...
export class FooterService {
  ...
  public submitFeedback(feedback:FeedbackInterface): Observable<{id:string}> {
    return this.http.post<{id:string}>(`${this.baseUrl}/user-feedback`, feedback).pipe(
  ...
  public updateFeedback(feedback:FeedbackInterface): Observable<void> {
    ...
    return this.http.patch<void>(`${this.baseUrl}/user-feedback/${feedbackId}`, feedback);
  }
}
